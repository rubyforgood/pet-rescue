...
ActiveRecord::Schema[7.1].define(version: 20_240_909_043_422) do
  ...
  create_table 'form_profiles', force: :cascade do |t|
    ...
    t.index %w[form_id profile_type], name: 'index_form_profiles_on_form_id_and_profile_type', unique: true
  ...
  create_table 'forms', force: :cascade do |t|
    ...
    t.index %w[organization_id name], name: 'index_forms_on_organization_id_and_name', unique: true
    t.index %w[organization_id title], name: 'index_forms_on_organization_id_and_title', unique: true
  ...
  create_table 'questions', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.datetime 'deleted_at', precision: nil
    t.index %w[form_id label], name: 'index_questions_on_form_id_and_label', unique: true
    t.index %w[form_id name], name: 'index_questions_on_form_id_and_name', unique: true
