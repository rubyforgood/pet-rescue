...
adopter_user_three = User.create!(email: 'd@c.com',
  first_name: 'Bad',
  last_name: 'Address',
  password: '123456',
  password_confirmation: '123456',
...
adopter_user_three.save()

adopter_account_three = AdopterAccount.create!(user_id: 4)

i = 1
until i == 10 do 
  Dog.create!(organization_id: 1,
              name: "dog #{i}",
              age: (i + 1),
              sex: 'Male',
...
profile_three = AdopterProfile.create!(adopter_account_id: 3,
                                 phone_number: '250 548 7721',
                                 contact_method: 'phone',
                                 country: 'Nonsense',
